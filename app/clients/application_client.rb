...
class ApplicationClient
  ...
  NET_HTTP_ERRORS = [Timeout::Error, Errno::EINVAL, Errno::ECONNRESET, EOFError, Net::HTTPBadResponse,
  ...
  def get(path, headers: {}, query: nil)
    make_request(klass: Net::HTTP::Get, path:, headers:, query:)
  end
  ...
  def post(path, headers: {}, query: nil, body: nil)
    make_request(klass: Net::HTTP::Post, path:, headers:, query:, body:)
  end
  ...
  def patch(path, headers: {}, query: nil, body: nil)
    make_request(klass: Net::HTTP::Patch, path:, headers:, query:, body:)
  end
  ...
  def put(path, headers: {}, query: nil, body: nil)
    make_request(klass: Net::HTTP::Put, path:, headers:, query:, body:)
  end
  ...
  def delete(path, headers: {}, query: nil, body: nil)
    make_request(klass: Net::HTTP::Delete, path:, headers:, query:, body:)
  end
