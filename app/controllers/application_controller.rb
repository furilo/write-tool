...
class ApplicationController < ActionController::Base
  ...
  def load_prompt_project_version
    @prompt_project = current_user.prompt_projects.where(slug: params[:prompt_project_id]).includes(:versions).take
    @prompt_project_version = @prompt_project.versions.find_by!(version: params[:prompt_project_version_id])
  end
